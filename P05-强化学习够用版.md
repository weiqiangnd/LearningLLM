...
这一节先讲怎么用"减去一个 baseline"这条几乎是免费的技巧把方差大幅压下来，下一节再把 PG + MC + baseline 拼成最小可执行的算法 REINFORCE。
...
加 baseline 是迈向"工业级策略梯度"的第一步——后面 **PPO / GRPO 都是 REINFORCE + 几条工程修补**：
